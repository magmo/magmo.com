...
[In November of last year](https://medium.com/magmo/we-launched-an-example-state-channel-app-17246bd98b05) we launched [Rock Paper Scissors](https://rps.magmo.com), the first application built on the ForceMove state channel protocol. Today we are happy to launch our second such application: Tic Tac Toe!
...
Check it out at [ttt.magmo.com](https://ttt.magmo.com)!

<img src="/images/ttt_screen.png" alt="Tic Tac Toe" width="100%"/>

Our apps are fully open-source on [GitHub](https://github.com/magmo/apps) and licensed under the MIT license.
...
If you have any questions or feedback, please come find us in our [Discord group!](https://discord.gg/UDQMgVa)
